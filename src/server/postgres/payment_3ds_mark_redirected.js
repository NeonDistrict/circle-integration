...
module.exports = payment_3ds_mark_redirected = (config, query, internal_purchase_id, payment_3ds_id, cb) => {
    purchase_log(internal_purchase_id, {
        event: 'payment_3ds_mark_redirected'
    });
