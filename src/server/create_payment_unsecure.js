...
module.exports = create_payment_unsecure = (internal_purchase_id, card_id, encrypted_card_information, email, phone_number, session_id, ip_address, sale_item, cb) => {
    ...
    postgres.payment_unsecure_start(internal_purchase_id, payment_unsecure_idempotency_key, (error) => {
        ...
        const request_body = {
            ...
            autoCapture: true,
            verification: 'none', // todo: is this correct?
            source: {
                id: card_id,
                type: 'card'
            },
