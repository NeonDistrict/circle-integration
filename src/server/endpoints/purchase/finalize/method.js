...
module.exports = async (body) => {
    ...
    if (purchase === null) {
        log({
            event: 'purchase finalize purchase not found',
            body: body
        });
    ...
    if (purchase.purchase_result === 'PENDING' && purchase.payment_3ds_result === 'REDIRECTED') {
        log({
            event: 'purchase finalize purchase was pending or redirected',
            body: body,
            purchase: purchase
        });
        ...
        log({
            event: 'purchase finalize purchase was not pending or redirected',
            body: body,
            purchase: purchase
        });
