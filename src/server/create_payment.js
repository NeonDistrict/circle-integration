...
module.exports = create_payment = async (internal_purchase_id, card_id, request_purchase, metadata, sale_item) => {
    ...
    // attempt 3ds payment
    const payment_3ds_assessment = await create_payment_3ds(internal_purchase_id, card_id, request_purchase, metadata, sale_item);
    ...
    const payment_cvv_assessment = await create_payment_cvv(internal_purchase_id, card_id, request_purchase, metadata, sale_item);
    ...
    const payment_unsecure_result = await create_payment_unsecure(internal_purchase_id, card_id, request_purchase, metadata, sale_item);
