...
const create_validation_status_enum = (config, query, cb) => {
    const text = 
    `
...
const create_purchases_table = (config, query, cb) => {
    ...
    CREATE TABLE "purchases" (
        ...
        "request_validation_result"          "VALIDATION_STATUS" NOT NULL,       -- if the circle integration servere request validation failed which is viewed as malicious since the client will dissallow malformed requests
